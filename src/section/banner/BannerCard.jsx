...
import { deleteBanner, editBanner } from "../../redux/store/slice/index.slice";
...
export default function BannerCard({ banner }) {
  ...
  const handleEditConfirmation = (newStatus) => {
    ...
    dispatch(editBanner({ data: EditFormData }));
  };
  ...
  const handleDeleteConfirmation = () => {
    ...
    dispatch(deleteBanner({ data: DeleteFormData }));
  };
